...
export const DashboardOverview: React.FC<DashboardOverviewProps> = ({
  ...
  return (
    <div className="space-y-6 font-sans">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 cyber-card p-6 rounded-3xl relative overflow-hidden border border-violet-500/30 shadow-lg">
        <div className="absolute top-0 right-0 w-96 h-96 bg-violet-600/10 rounded-full blur-3xl pointer-events-none" />
        <div className="relative z-10">
          <div className="flex items-center gap-2 mb-2">
            <span className="w-2 h-2 rounded-full bg-violet-400 animate-pulse" />
            <span className="text-xs font-bold text-violet-400 uppercase tracking-widest font-mono">CYGRX ENTERPRISE DEFENSE OS</span>
            <span className="px-2.5 py-0.5 rounded-full text-[9px] font-bold bg-violet-950/90 text-violet-300 border border-violet-500/40 font-mono uppercase">
              LIVE SOC TELEMETRY
            </span>
          </div>
        ...
        <div className="flex items-center gap-3 relative z-10 shrink-0">
          <button
            ...
            className="flex items-center gap-2 px-4 py-2.5 rounded-xl text-xs font-semibold font-mono bg-gradient-to-r from-violet-600 to-indigo-600 hover:from-violet-500 hover:to-indigo-500 text-white shadow-md transition-all border border-violet-400/50 cursor-pointer"
          >
      ...
      <div className="grid grid-cols-12 gap-4 sm:gap-6">
        ...
        <div 
          ...
          className="col-span-12 lg:col-span-8 bg-slate-900 border border-slate-800 hover:border-violet-400/60 p-6 rounded-2xl cursor-pointer transition-all group flex flex-col justify-between relative overflow-hidden"
        >
          <div>
            <div className="flex items-center justify-between mb-4">
              ...
              <span className="text-xs font-mono text-cyan-300 bg-cyan-950/80 px-2.5 py-1 rounded-full border border-cyan-500/40 flex items-center gap-1.5">
            ...
            <div className="flex flex-col sm:flex-row sm:items-baseline justify-between gap-4">
              <div>
                <div className="flex items-baseline gap-3">
                  <span className="text-5xl font-black text-white font-mono tracking-tighter">{openRisks.length}</span>
                  <span className="text-sm text-slate-400 font-mono">/ {totalRisks} total identified threat vectors</span>
                </div>
                <p className="text-sm text-slate-300 mt-2 font-mono flex items-center gap-2">
                  <span className="text-rose-400 font-bold bg-rose-950/80 px-2.5 py-0.5 rounded-full border border-rose-500/40">
              ...
              <div className="flex items-end gap-1.5 h-14 pt-2">
                ...
                <div className="w-3 bg-violet-600 rounded-t h-[85%]" />
                <div className="w-3 bg-cyan-400 rounded-t h-[60%]" />
                <div className="w-3 bg-indigo-500 rounded-t h-[100%]" />
              </div>
            </div>
          </div>
        ...
        <div 
          ...
          className="col-span-12 lg:col-span-4 bg-gradient-to-br from-violet-950 via-slate-900 to-cyan-950 text-white p-6 rounded-2xl cursor-pointer shadow-lg flex flex-col justify-between group relative overflow-hidden border border-violet-500/50"
        >
          ...
          <div>
            <div className="flex items-center justify-between mb-3">
              <span className="text-xs font-bold text-violet-300 uppercase tracking-widest font-mono">AUDIT READINESS SCORE</span>
            ...
            <div className="mt-2">
              <span className="text-5xl font-black text-white font-mono tracking-tighter">{isoScore}%</span>
              <p className="text-sm text-slate-200 mt-2 font-mono leading-relaxed">
        ...
        <div 
          ...
          className="col-span-12 sm:col-span-6 lg:col-span-4 bg-slate-900 border border-slate-800 p-5 rounded-2xl cursor-pointer transition-all group"
        >
          <div className="flex items-center justify-between mb-3">
            <span className="text-xs font-bold text-slate-400 uppercase tracking-widest font-mono">NIST CSF 2.0 MATURITY</span>
          ...
          <p className="text-sm text-slate-300 mt-2 font-medium">Identify, Protect, Detect, Respond, Recover functions active.</p>
        ...
        >
          <div className="flex items-center justify-between mb-3">
            <span className="text-xs font-bold text-slate-400 uppercase tracking-widest font-mono">ACTIVE INCIDENTS</span>
          ...
          <p className="text-sm text-slate-300 mt-2 font-medium">Monitoring {assets.length} cloud & enterprise assets.</p>
        ...
        <div 
          onClick={() => onSelectTab("ai-advisor")}
          className="col-span-12 lg:col-span-4 bg-slate-900 border border-slate-800 p-5 rounded-2xl cursor-pointer transition-all group flex flex-col justify-between"
        >
          <div>
            <div className="flex items-center justify-between mb-3">
              <span className="text-xs font-bold text-violet-400 uppercase tracking-widest font-mono flex items-center gap-1.5">
        ...
        <div className="col-span-12 lg:col-span-8 bg-slate-900 border border-slate-800 rounded-2xl p-6">
          <div className="flex items-center justify-between mb-4">
            <div>
              <span className="text-xs font-bold text-slate-400 uppercase tracking-widest font-mono">SECURITY EXPOSURE LOG</span>
              ...
              return (
                ...
                >
                  <div className="space-y-1">
                    ...
                    <div className="flex items-center gap-4 text-sm text-slate-500 font-mono pt-1">
        ...
        <div className="col-span-12 lg:col-span-4 bg-slate-900 border border-slate-800 rounded-2xl p-6 flex flex-col justify-between">
          <div>
            <span className="text-xs font-bold text-slate-400 uppercase tracking-widest font-mono">DISTRIBUTION MATRIX</span>
            <h2 className="text-base font-bold text-white font-mono mt-0.5 mb-1">Risk Severity Breakdown</h2>
            <p className="text-sm text-slate-400 mb-4">Categorized by Likelihood × Impact rating</p>
