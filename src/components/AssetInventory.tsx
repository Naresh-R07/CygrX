  ...
  return (
    <div className="space-y-6 font-sans">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 bg-slate-900 border border-slate-800 p-6 rounded-2xl relative overflow-hidden">
        <div>
          <span className="text-[10px] font-bold text-slate-500 uppercase tracking-widest font-mono">ASSET VAULT</span>
        ...
        <button
          ...
          className="flex items-center gap-2 px-4 py-2 rounded-xl text-xs font-semibold font-mono bg-indigo-600 hover:bg-indigo-500 text-white shadow-lg shadow-indigo-950/50 border border-indigo-400/30 transition-all shrink-0"
        >
            ...
            >
              <div className="space-y-2">
                <div className="flex items-center justify-between">
                  ...
                  <span className={`px-2 py-0.5 rounded text-[10px] font-bold border ${getCriticalityBadge(asset.criticality)}`}>
                    {asset.criticality}
                  </span>
                </div>
                ...
                {asset.ipAddress && (
                  <p className="text-xs font-mono text-cyan-400 bg-slate-900/80 px-2 py-1 rounded border border-slate-800 inline-block">
                    {asset.ipAddress}
                  </p>
                )}
              </div>
          ...
          <div className="bg-slate-900 border border-slate-800 rounded-2xl w-full max-w-lg shadow-2xl overflow-hidden">
            ...
            <form onSubmit={handleCreateAsset} className="p-6 space-y-4 text-xs">
              ...
              <div className="flex justify-end gap-3 pt-4 border-t border-slate-800">
                ...
                <button
                  type="submit"
                  className="px-5 py-2 rounded-xl font-semibold bg-cyan-600 hover:bg-cyan-500 text-white shadow-lg shadow-cyan-950/50 border border-cyan-400/30"
                >
                  Save Asset
                </button>
              </div>
